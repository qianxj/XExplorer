...
class  CExcelShapes : public CDispatchDriver
{
public:
	 CExcelShapes() {} // 调用 COleDispatchDriver 默认构造函数
	 CExcelShapes(LPDISPATCH pDispatch) : CDispatchDriver(pDispatch) {}
	 CExcelShapes(const  CExcelShapes& dispatchSrc) : CDispatchDriver(dispatchSrc) {}
