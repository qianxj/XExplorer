...
class CWorkbook : public CDispatchDriver
{
public:
	CWorkbook(){} // 调用 CDispatchDriver 默认构造函数
	CWorkbook(LPDISPATCH pDispatch) : CDispatchDriver(pDispatch) {}
	CWorkbook(const CWorkbook& dispatchSrc) : CDispatchDriver(dispatchSrc) {}
