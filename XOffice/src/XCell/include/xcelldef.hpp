...
#define  goVisibleSelection		 0x800000
...
struct  TGridAxisDrawInfo{
    ...
    int         FirstGridCell;
    int         GridCellCount;
	int         (CHxGrid::* GetExtent)(int index);
};
*/
...
struct TGridDrawColor
{
	struct tagColHeaderColor
	{
		COLORREF	color0;
		COLORREF	color1;
	} ColHeaderColor;
	struct tagRowSelectorColor
	{
		COLORREF	color0;
		COLORREF	color1;
	} RowSelectorColor;
