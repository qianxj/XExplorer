// XPageSheet.cpp : 定义 DLL 应用程序的入口点。
//
...
static tagXClassRelInfo XClassRelInfo[] = {
	{	_T("xpagesheet"),	XFrameWndClass,WS_CHILD | WS_VISIBLE,	0	}
};
...
bool WINAPI CreateInstance(LPTSTR pStrObject,xbObject * &pxbObject)
{
	...
	if(nIndex>=0)
	{
		if(::_tcsicmp(pStrObject,_T("xpagesheet"))==0)
		{
			pxbObject = new XOffice::XPage::XPageSheet();
		}else
			return false;
