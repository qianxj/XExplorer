...
static tagXClassRelInfo XClassRelInfo[] = {
	{	_T("xreport"),	XFrameWndClass,WS_CHILD | WS_VISIBLE,	0	}/*,
	{	_T("xgrid"),	XFrameWndClass,WS_CHILD | WS_VISIBLE,	0	}*/
};
...
bool WINAPI CreateInstance(LPTSTR pStrObject,xbObject * &pxbObject)
{
	...
	if(nIndex>=0)
	{
		if(::_tcsicmp(pStrObject,_T("xreport"))==0)
		{
			pxbObject = new XOffice::XReport::XReportSheet();
		}/*else if(::_tcsicmp(pStrObject,_T("xgrid"))==0)
		{
			pxbObject = new XOffice::XReport::XGridReport();
		}*/else
			return false;
