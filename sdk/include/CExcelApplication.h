...
class XCONTROL_API CExcelApplication : public CDispatchDriver
{
public:
	CExcelApplication(){} // 调用 CDispatchDriver 默认构造函数
	CExcelApplication(LPDISPATCH pDispatch) : CDispatchDriver(pDispatch) {}
	CExcelApplication(const CExcelApplication& dispatchSrc) : CDispatchDriver(dispatchSrc) {}
...
public:
	...
	wchar_t* get__Default()
	{
		wchar_t* result;
		InvokeHelper(0x0, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, NULL);
		return result;
	}
	wchar_t* get_DefaultFilePath()
	{
		wchar_t* result;
	...
	wchar_t* get_NetworkTemplatesPath()
	{
		wchar_t* result;
	...
	wchar_t* GetPhonetic(VARIANT& Text)
	{
		wchar_t* result;
		static BYTE parms[] = VTS_VARIANT ;
	...
	wchar_t* get_ThousandsSeparator()
	{
		wchar_t* result;
...
public:
	// 操作
public:
	static CExcelApplication* CreateInstance();
	void Release(CExcelApplication * );
public:
	//method
	void OpenDocument(const LPTSTR FileName);
