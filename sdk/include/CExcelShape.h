...
class CExcelShape : public CDispatchDriver
{
public:
	CExcelShape() {} // 调用 CDispatchDriver 默认构造函数
	CExcelShape(LPDISPATCH pDispatch) : CDispatchDriver(pDispatch) {}
	CExcelShape(const CExcelShape& dispatchSrc) : CDispatchDriver(dispatchSrc) {}
