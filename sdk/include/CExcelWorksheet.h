...
class CWorksheet : public CDispatchDriver
{
public:
	CWorksheet() {} // 调用 COleDispatchDriver 默认构造函数
	CWorksheet(LPDISPATCH pDispatch) : CDispatchDriver(pDispatch) {}
	CWorksheet(const CWorksheet& dispatchSrc) : CDispatchDriver(dispatchSrc) {}
