...
#include "vxigriddatasvr.hxx"
#include "vxigridsheetsvr.hxx"
#include "vxiscrollbar.hxx"
#include "vxvxiaxissvr.hxx"
#include "vxvxiRowselector.hxx"
#include "vxiHeaderselector.hxx"

namespace Hxsoft{ namespace XFrame{ namespace XOffice
{
	class XOFOBJECT_API XGridSheetSvr : public CSvrbase
	{
	public:
		XGridSheetSvr(void);
		~XGridSheetSvr(void);
	...
	public:
		IGridDataSvr * m_pGridDataSvr;
		XAPI void SetGridDataSvr(IGridDataSvr * pGridDataSvr);
		XAPI IGridDataSvr * GetGridDataSvr();
	public:
		class IGridSheet * m_pGridSheet;
		XAPI void SetIGridSheet(IGridSheet * pGridSheet);
		XAPI IGridSheet * GetIGridSheet();
	...
	public:
		...
		int DoCalc(const TGridAxisDrawInfo &AxisInfo, int N);
		XAPI TGridCoord CalcCoordFromPoint(POINT pt);
		XAPI TGridCoord CalcCoordFromPoint(POINT pt,const TGridDrawInfo & DrawInfo);
	...
	public:
		...
		BOOL CalcScroll(TGridAxisDrawInfo &AxisInfo, int OldPos, int CurrentPos, int &Amount);

		IScrollBar * FHScrollBar;
		IScrollBar * FVScrollBar;
		IScrollBar * GetHScrollBar();
		IScrollBar * GetVScrollBar();
	public:
