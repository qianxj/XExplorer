...
namespace Hxsoft{ namespace XFrame{ namespace XOffice {namespace XReport
{
	...
	class XREPORT_API CEditSvr :public xfAreaObject
	{
	public:
	...
	public:
		template class XREPORT_API XUtil::xuVector<tagEditCtlBuff* >;
	...
	public:
		LPTSTR  (* m_pGetCellContent)(XOfficeSheetSvr * pOwner,int ACol,int ARow) ; 
		int		(*m_pSetCellContent)(XOfficeSheetSvr * pOwner,int ACol,int ARow,LPTSTR pStr);
		LPTSTR  (*m_pGetEditType)(XOfficeSheetSvr * pOwner,int ACol,int ARow);
		int		(*m_pGetCellRect)(XOfficeSheetSvr * pOwner,int ACol,int ARow,RECT &rt);
		HFONT   (*m_pGetFont)(XOfficeSheetSvr * pOwner,int ACol,int ARow);
	};
}}}}