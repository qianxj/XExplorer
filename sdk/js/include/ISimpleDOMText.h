...
/* at Sun Jul 31 18:40:06 2011
 */
/* Compiler settings for d:/firefox-5.0.1/mozilla-release/accessible/public/msaa/ISimpleDOMText.idl:
...
/* interface __MIDL_itf_ISimpleDOMText_0000 */
/* [local] */ 
...
extern RPC_IF_HANDLE __MIDL_itf_ISimpleDOMText_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_ISimpleDOMText_0000_v0_0_s_ifspec;
...
/* [propget] */ HRESULT STDMETHODCALLTYPE ISimpleDOMText_get_domText_Proxy( 
    ISimpleDOMText * This,
    /* [retval][out] */ BSTR *domText);


void __RPC_STUB ISimpleDOMText_get_domText_Stub(
    IRpcStubBuffer *This,
...
HRESULT STDMETHODCALLTYPE ISimpleDOMText_get_clippedSubstringBounds_Proxy( 
    ISimpleDOMText * This,
    /* [in] */ unsigned int startIndex,
    /* [in] */ unsigned int endIndex,
    /* [out] */ int *x,
...
void __RPC_STUB ISimpleDOMText_get_clippedSubstringBounds_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE ISimpleDOMText_get_unclippedSubstringBounds_Proxy( 
    ISimpleDOMText * This,
    /* [in] */ unsigned int startIndex,
    /* [in] */ unsigned int endIndex,
    /* [out] */ int *x,
...
void __RPC_STUB ISimpleDOMText_get_unclippedSubstringBounds_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE ISimpleDOMText_scrollToSubstring_Proxy( 
    ISimpleDOMText * This,
    /* [in] */ unsigned int startIndex,
    /* [in] */ unsigned int endIndex);


void __RPC_STUB ISimpleDOMText_scrollToSubstring_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [propget] */ HRESULT STDMETHODCALLTYPE ISimpleDOMText_get_fontFamily_Proxy( 
    ISimpleDOMText * This,
    /* [retval][out] */ BSTR *fontFamily);


void __RPC_STUB ISimpleDOMText_get_fontFamily_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
