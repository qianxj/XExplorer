/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM d:/firefox-5.0.1/mozilla-release/content/base/public/nsIDOMFile.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMBlob : public nsISupports {
 public: 
  ...
  /* [noscript] nsIDOMBlob slice (in unsigned long long start, in unsigned long long length, [optional] in DOMString contentType); */
  NS_IMETHOD Slice(PRUint64 start, PRUint64 length, const nsAString & contentType, nsIDOMBlob **_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIDOMBLOB \
  ...
  NS_IMETHOD Slice(PRUint64 start, PRUint64 length, const nsAString & contentType, nsIDOMBlob **_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIDOMBLOB(_to) \
  ...
  NS_IMETHOD Slice(PRUint64 start, PRUint64 length, const nsAString & contentType, nsIDOMBlob **_retval NS_OUTPARAM) { return _to Slice(start, length, contentType, _retval); } \
...
#define NS_FORWARD_SAFE_NSIDOMBLOB(_to) \
  ...
  NS_IMETHOD Slice(PRUint64 start, PRUint64 length, const nsAString & contentType, nsIDOMBlob **_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->Slice(start, length, contentType, _retval); } \
...
/* starting interface:    nsIDOMBlob_MOZILLA_2_0_BRANCH */
#define NS_IDOMBLOB_MOZILLA_2_0_BRANCH_IID_STR "cb5b4191-a555-4e57-b8d2-88091184b59f"

#define NS_IDOMBLOB_MOZILLA_2_0_BRANCH_IID \
  {0xcb5b4191, 0xa555, 0x4e57, \
    { 0xb8, 0xd2, 0x88, 0x09, 0x11, 0x84, 0xb5, 0x9f }}

class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMBlob_MOZILLA_2_0_BRANCH : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IDOMBLOB_MOZILLA_2_0_BRANCH_IID)

  /* [optional_argc] nsIDOMBlob mozSlice (in long long start, [optional] in long long end, [optional] in DOMString contentType); */
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(nsIDOMBlob_MOZILLA_2_0_BRANCH, NS_IDOMBLOB_MOZILLA_2_0_BRANCH_IID)

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIDOMBLOB_MOZILLA_2_0_BRANCH \
...
/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMBLOB_MOZILLA_2_0_BRANCH(_to) \
...
/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMBLOB_MOZILLA_2_0_BRANCH(_to) \
...
/* Header file */
class nsDOMBlob_MOZILLA_2_0_BRANCH : public nsIDOMBlob_MOZILLA_2_0_BRANCH
{
public:
  NS_DECL_ISUPPORTS
  NS_DECL_NSIDOMBLOB_MOZILLA_2_0_BRANCH

  nsDOMBlob_MOZILLA_2_0_BRANCH();
...
/* Implementation file */
NS_IMPL_ISUPPORTS1(nsDOMBlob_MOZILLA_2_0_BRANCH, nsIDOMBlob_MOZILLA_2_0_BRANCH)

nsDOMBlob_MOZILLA_2_0_BRANCH::nsDOMBlob_MOZILLA_2_0_BRANCH()
{
  /* member initializers and constructor code */
}
...
/* [optional_argc] nsIDOMBlob mozSlice (in long long start, [optional] in long long end, [optional] in DOMString contentType); */
NS_IMETHODIMP nsDOMBlob_MOZILLA_2_0_BRANCH::MozSlice(PRInt64 start, PRInt64 end, const nsAString & contentType, PRUint8 _argc, nsIDOMBlob **_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
