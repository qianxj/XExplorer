/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM d:/firefox-5.0.1/mozilla-release/uriloader/exthandler/nsIExternalProtocolService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIExternalProtocolService : public nsISupports {
 public: 
  ...
  NS_DEPRECATED NS_SCRIPTABLE NS_IMETHOD LoadUrl(nsIURI *aURL) = 0;
...
#define NS_DECL_NSIEXTERNALPROTOCOLSERVICE \
  ...
  NS_DEPRECATED NS_SCRIPTABLE NS_IMETHOD LoadUrl(nsIURI *aURL); \
...
#define NS_FORWARD_NSIEXTERNALPROTOCOLSERVICE(_to) \
  ...
  NS_DEPRECATED NS_SCRIPTABLE NS_IMETHOD LoadUrl(nsIURI *aURL) { return _to LoadUrl(aURL); } \
...
#define NS_FORWARD_SAFE_NSIEXTERNALPROTOCOLSERVICE(_to) \
  ...
  NS_DEPRECATED NS_SCRIPTABLE NS_IMETHOD LoadUrl(nsIURI *aURL) { return !_to ? NS_ERROR_NULL_POINTER : _to->LoadUrl(aURL); } \
