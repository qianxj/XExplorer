/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM d:/firefox-5.0.1/mozilla-release/docshell/base/nsIMarkupDocumentViewer.idl
 */
...
/* starting interface:    nsIMarkupDocumentViewer_MOZILLA_2_0_BRANCH */
#define NS_IMARKUPDOCUMENTVIEWER_MOZILLA_2_0_BRANCH_IID_STR "cadfcad1-5570-4dac-b5a2-cd1ea751fe29"

#define NS_IMARKUPDOCUMENTVIEWER_MOZILLA_2_0_BRANCH_IID \
  {0xcadfcad1, 0x5570, 0x4dac, \
    { 0xb5, 0xa2, 0xcd, 0x1e, 0xa7, 0x51, 0xfe, 0x29 }}

class NS_NO_VTABLE NS_SCRIPTABLE nsIMarkupDocumentViewer_MOZILLA_2_0_BRANCH : public nsIMarkupDocumentViewer {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IMARKUPDOCUMENTVIEWER_MOZILLA_2_0_BRANCH_IID)
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(nsIMarkupDocumentViewer_MOZILLA_2_0_BRANCH, NS_IMARKUPDOCUMENTVIEWER_MOZILLA_2_0_BRANCH_IID)

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIMARKUPDOCUMENTVIEWER_MOZILLA_2_0_BRANCH \
  NS_SCRIPTABLE NS_IMETHOD GetMinFontSize(PRInt32 *aMinFontSize); \
  NS_SCRIPTABLE NS_IMETHOD SetMinFontSize(PRInt32 aMinFontSize); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIMARKUPDOCUMENTVIEWER_MOZILLA_2_0_BRANCH(_to) \
...
/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIMARKUPDOCUMENTVIEWER_MOZILLA_2_0_BRANCH(_to) \
...
/* Header file */
class nsMarkupDocumentViewer_MOZILLA_2_0_BRANCH : public nsIMarkupDocumentViewer_MOZILLA_2_0_BRANCH
{
public:
  NS_DECL_ISUPPORTS
  NS_DECL_NSIMARKUPDOCUMENTVIEWER_MOZILLA_2_0_BRANCH

  nsMarkupDocumentViewer_MOZILLA_2_0_BRANCH();
...
/* Implementation file */
NS_IMPL_ISUPPORTS1(nsMarkupDocumentViewer_MOZILLA_2_0_BRANCH, nsIMarkupDocumentViewer_MOZILLA_2_0_BRANCH)

nsMarkupDocumentViewer_MOZILLA_2_0_BRANCH::nsMarkupDocumentViewer_MOZILLA_2_0_BRANCH()
{
  /* member initializers and constructor code */
}
...
/* attribute long minFontSize; */
NS_IMETHODIMP nsMarkupDocumentViewer_MOZILLA_2_0_BRANCH::GetMinFontSize(PRInt32 *aMinFontSize)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsMarkupDocumentViewer_MOZILLA_2_0_BRANCH::SetMinFontSize(PRInt32 aMinFontSize)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
