/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM d:/firefox-5.0.1/mozilla-release/modules/plugin/base/public/nsIPluginHost.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIPluginHost : public nsISupports {
 public: 
   ...
   */
  /* [noscript] void getURL (in nsISupports pluginInt, in string url, in string target, in nsIPluginStreamListener streamListener, in string altHost, in string referrer, in boolean forceJSEnabled); */
  NS_IMETHOD GetURL(nsISupports *pluginInt, const char *url, const char *target, nsIPluginStreamListener *streamListener, const char *altHost, const char *referrer, PRBool forceJSEnabled) = 0;
   ...
   * @result - NS_OK if this operation was successful
   */
  /* [noscript] void postURL (in nsISupports pluginInst, in string url, in PRUint32 postDataLen, in string postData, in boolean isFile, in string target, in nsIPluginStreamListener streamListener, in string altHost, in string referrer, in boolean forceJSEnabled, in PRUint32 postHeadersLength, in string postHeaders); */
  NS_IMETHOD PostURL(nsISupports *pluginInst, const char *url, PRUint32 postDataLen, const char *postData, PRBool isFile, const char *target, nsIPluginStreamListener *streamListener, const char *altHost, const char *referrer, PRBool forceJSEnabled, PRUint32 postHeadersLength, const char *postHeaders) = 0;
  ...
  NS_IMETHOD_(void) AddIdleTimeTarget(nsIPluginInstanceOwner *objectFrame, PRBool isVisible) = 0;

  /* [noscript, notxpcom] void removeIdleTimeTarget (in nsIPluginInstanceOwner objectFrame); */
  NS_IMETHOD_(void) RemoveIdleTimeTarget(nsIPluginInstanceOwner *objectFrame) = 0;
...
#define NS_DECL_NSIPLUGINHOST \
  ...
  NS_IMETHOD GetURL(nsISupports *pluginInt, const char *url, const char *target, nsIPluginStreamListener *streamListener, const char *altHost, const char *referrer, PRBool forceJSEnabled); \
  NS_IMETHOD PostURL(nsISupports *pluginInst, const char *url, PRUint32 postDataLen, const char *postData, PRBool isFile, const char *target, nsIPluginStreamListener *streamListener, const char *altHost, const char *referrer, PRBool forceJSEnabled, PRUint32 postHeadersLength, const char *postHeaders); \
  ...
  NS_IMETHOD_(void) AddIdleTimeTarget(nsIPluginInstanceOwner *objectFrame, PRBool isVisible); \
  NS_IMETHOD_(void) RemoveIdleTimeTarget(nsIPluginInstanceOwner *objectFrame); \
...
#define NS_FORWARD_NSIPLUGINHOST(_to) \
  ...
  NS_IMETHOD GetURL(nsISupports *pluginInt, const char *url, const char *target, nsIPluginStreamListener *streamListener, const char *altHost, const char *referrer, PRBool forceJSEnabled) { return _to GetURL(pluginInt, url, target, streamListener, altHost, referrer, forceJSEnabled); } \
  NS_IMETHOD PostURL(nsISupports *pluginInst, const char *url, PRUint32 postDataLen, const char *postData, PRBool isFile, const char *target, nsIPluginStreamListener *streamListener, const char *altHost, const char *referrer, PRBool forceJSEnabled, PRUint32 postHeadersLength, const char *postHeaders) { return _to PostURL(pluginInst, url, postDataLen, postData, isFile, target, streamListener, altHost, referrer, forceJSEnabled, postHeadersLength, postHeaders); } \
  ...
  NS_IMETHOD_(void) AddIdleTimeTarget(nsIPluginInstanceOwner *objectFrame, PRBool isVisible) { return _to AddIdleTimeTarget(objectFrame, isVisible); } \
  NS_IMETHOD_(void) RemoveIdleTimeTarget(nsIPluginInstanceOwner *objectFrame) { return _to RemoveIdleTimeTarget(objectFrame); } \
...
#define NS_FORWARD_SAFE_NSIPLUGINHOST(_to) \
  ...
  NS_IMETHOD GetURL(nsISupports *pluginInt, const char *url, const char *target, nsIPluginStreamListener *streamListener, const char *altHost, const char *referrer, PRBool forceJSEnabled) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetURL(pluginInt, url, target, streamListener, altHost, referrer, forceJSEnabled); } \
  NS_IMETHOD PostURL(nsISupports *pluginInst, const char *url, PRUint32 postDataLen, const char *postData, PRBool isFile, const char *target, nsIPluginStreamListener *streamListener, const char *altHost, const char *referrer, PRBool forceJSEnabled, PRUint32 postHeadersLength, const char *postHeaders) { return !_to ? NS_ERROR_NULL_POINTER : _to->PostURL(pluginInst, url, postDataLen, postData, isFile, target, streamListener, altHost, referrer, forceJSEnabled, postHeadersLength, postHeaders); } \
  ...
  NS_IMETHOD_(void) AddIdleTimeTarget(nsIPluginInstanceOwner *objectFrame, PRBool isVisible) { return !_to ? NS_ERROR_NULL_POINTER : _to->AddIdleTimeTarget(objectFrame, isVisible); } \
  NS_IMETHOD_(void) RemoveIdleTimeTarget(nsIPluginInstanceOwner *objectFrame) { return !_to ? NS_ERROR_NULL_POINTER : _to->RemoveIdleTimeTarget(objectFrame); } \
...
/* [noscript] void getURL (in nsISupports pluginInt, in string url, in string target, in nsIPluginStreamListener streamListener, in string altHost, in string referrer, in boolean forceJSEnabled); */
NS_IMETHODIMP nsPluginHost::GetURL(nsISupports *pluginInt, const char *url, const char *target, nsIPluginStreamListener *streamListener, const char *altHost, const char *referrer, PRBool forceJSEnabled)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* [noscript] void postURL (in nsISupports pluginInst, in string url, in PRUint32 postDataLen, in string postData, in boolean isFile, in string target, in nsIPluginStreamListener streamListener, in string altHost, in string referrer, in boolean forceJSEnabled, in PRUint32 postHeadersLength, in string postHeaders); */
NS_IMETHODIMP nsPluginHost::PostURL(nsISupports *pluginInst, const char *url, PRUint32 postDataLen, const char *postData, PRBool isFile, const char *target, nsIPluginStreamListener *streamListener, const char *altHost, const char *referrer, PRBool forceJSEnabled, PRUint32 postHeadersLength, const char *postHeaders)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* [noscript, notxpcom] void addIdleTimeTarget (in nsIPluginInstanceOwner objectFrame, in boolean isVisible); */
NS_IMETHODIMP_(void) nsPluginHost::AddIdleTimeTarget(nsIPluginInstanceOwner *objectFrame, PRBool isVisible)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* [noscript, notxpcom] void removeIdleTimeTarget (in nsIPluginInstanceOwner objectFrame); */
NS_IMETHODIMP_(void) nsPluginHost::RemoveIdleTimeTarget(nsIPluginInstanceOwner *objectFrame)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
