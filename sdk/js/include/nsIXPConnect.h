/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM d:/firefox-5.0.1/mozilla-release/js/src/xpconnect/idl/nsIXPConnect.idl
 */
...
#define NS_IXPCONNECT_IID_STR "f99ffb06-4e7b-4bab-83d4-7d573235a08a"

#define NS_IXPCONNECT_IID \
  {0xf99ffb06, 0x4e7b, 0x4bab, \
    { 0x83, 0xd4, 0x7d, 0x57, 0x32, 0x35, 0xa0, 0x8a }}
...
/**
  ...
  NS_DEPRECATED NS_IMETHOD SyncJSContexts(void) = 0;
  ...
  NS_DEPRECATED NS_IMETHOD SetSafeJSContextForCurrentThread(JSContext *cx) = 0;
...
#define NS_DECL_NSIXPCONNECT \
  ...
  NS_DEPRECATED NS_IMETHOD SyncJSContexts(void); \
  ...
  NS_DEPRECATED NS_IMETHOD SetSafeJSContextForCurrentThread(JSContext *cx); \
...
#define NS_FORWARD_NSIXPCONNECT(_to) \
  ...
  NS_DEPRECATED NS_IMETHOD SyncJSContexts(void) { return _to SyncJSContexts(); } \
  ...
  NS_DEPRECATED NS_IMETHOD SetSafeJSContextForCurrentThread(JSContext *cx) { return _to SetSafeJSContextForCurrentThread(cx); } \
...
#define NS_FORWARD_SAFE_NSIXPCONNECT(_to) \
  ...
  NS_DEPRECATED NS_IMETHOD SyncJSContexts(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->SyncJSContexts(); } \
  ...
  NS_DEPRECATED NS_IMETHOD SetSafeJSContextForCurrentThread(JSContext *cx) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetSafeJSContextForCurrentThread(cx); } \
