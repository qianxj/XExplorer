/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM d:/firefox-5.0.1/mozilla-release/js/src/xpconnect/idl/xpccomponents.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIXPCComponents : public nsISupports {
 public: 
  ...
  NS_DEPRECATED NS_SCRIPTABLE NS_IMETHOD LookupMethod(void) = 0;

  /* [deprecated] void reportError (); */
  NS_DEPRECATED NS_SCRIPTABLE NS_IMETHOD ReportError(void) = 0;
...
#define NS_DECL_NSIXPCCOMPONENTS \
  ...
  NS_DEPRECATED NS_SCRIPTABLE NS_IMETHOD LookupMethod(void); \
  NS_DEPRECATED NS_SCRIPTABLE NS_IMETHOD ReportError(void); 
...
#define NS_FORWARD_NSIXPCCOMPONENTS(_to) \
  ...
  NS_DEPRECATED NS_SCRIPTABLE NS_IMETHOD LookupMethod(void) { return _to LookupMethod(); } \
  NS_DEPRECATED NS_SCRIPTABLE NS_IMETHOD ReportError(void) { return _to ReportError(); } 
...
#define NS_FORWARD_SAFE_NSIXPCCOMPONENTS(_to) \
  ...
  NS_DEPRECATED NS_SCRIPTABLE NS_IMETHOD LookupMethod(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->LookupMethod(); } \
  NS_DEPRECATED NS_SCRIPTABLE NS_IMETHOD ReportError(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->ReportError(); } 
