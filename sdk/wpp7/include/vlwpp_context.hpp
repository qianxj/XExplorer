#ifndef WPP7_WPP7_CONTEXT_H
#define WPP7_WPP7_CONTEXT_H
...
public:
	void set_error(vlError* errPtr_); 
	vlError* get_error(); 
	vlError* get_rrror(){return get_error();}
public:
